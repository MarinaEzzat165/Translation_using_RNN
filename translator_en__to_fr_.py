# -*- coding: utf-8 -*-
"""translator_EN _to_FR .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jfa1vDoHnWHmTb30N0fonxk6pb0-PKFE
"""

import string
import re
from pickle import dump   # to store training data & weights
...
testX = encode_sequences(ger_tokenizer, ger_length, test[:, 0])
...
from nltk.translate.bleu_score import corpus_bleu # give score to the model
...
# generate target given sorce sequence
...
def evaluate_model(model , tokenizer , source, raw_dataset):
  ...
  for i , source in enumerate(source):
    ...
    raw_target , raw_src = raw_dataset[i] , raw_dataset[i]
    if i <10:
...
trainY = encode_sequences(ger_tokenizer,ger_length,test[:,1])

# load model
model = load_model('/content/model.h5')

# test on some training sequence
print('train')
evaluate_model(model, eng_tokenizer, trainX, train)

# test on some test sequence
print('test')
